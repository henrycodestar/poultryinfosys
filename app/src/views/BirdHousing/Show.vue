                ...
                <div class="container-fluid">
                            ...
                            <div class="container-fluid flex items-center p-0">
                                <div class="col-md-11">
                                    <p class="inline-block p-8 bg-white border-l-4 border-grey-dark">
                                        View all Housing details and Manage it below.
                                    </p>
                                </div>
                                <div class="col-md-1">
                        ...
                        <div class="row">
                            <div class="container-fluid flex items-center pb-0">
                                ...
                                <div class="col-md-9 flex justify-end items-center">
                                    <router-link :to="'/bird-housing/'+this.birdHousingID+'/edit'" class="btn btn-warning m-1"><span class="btn-label"><i class="mdi mdi-pencil"></i></span> Edit</router-link>
                                ...
                                <div class="col-md-11">
                                    ...
                                    <div class="row">
                                        <div class="container-fluid p-0">
                                            <div class="col-md-2">
                                                <span class="font-medium">House ID</span>
                                                <p>{{ getValue(this.trackedEntityInstance, 's75rVKmfQwx')}}</p>
                                            </div>
                                            <div class="col-md-2">
                                                <span class="font-medium">Bird Type</span>
                                                <p>{{ getValue(this.trackedEntityInstance, 'QpOxrQsVHLG')}}</p>
                                            </div>
                                            <div class="col-md-3">
                    ...
                    <div class="mt-8">
                        <div class="row">
                            <div>
                                <div class="col-md-4">
                                    <router-link :to="'/bird-housing/'+this.birdHousingID+'/conditions'">
