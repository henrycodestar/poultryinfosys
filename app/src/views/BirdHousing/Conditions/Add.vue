                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><router-link :to="'/bird-housing/'+this.birdHousingID+'/conditions'">Conditions</router-link></li>
                            <li><a>Add</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                            ...
                            <div class="container-fluid flex items-center p-0">
                                <div class="col-md-11">
                                    <p class="inline-block p-8 bg-white border-l-2 border-blue-dark">
                                        Use the Input Form below to Add a New Conditions.
                                    </p>
                                </div>
                                <div class="col-md-1">
                                            ...
                                            <div class="col-md-8">
                                                <form v-on:submit.prevent="submit">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="1" v-model="conditionDate" class="form-control h-16 border-2 border-grey-dark focus:border-2 focus:border-blue focus:shadow rounded" type="date" required>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="font-medium" for="2">Temperature</label>
                                                        <input id="2" v-model="temperature" class="form-control h-16 border-2 border-grey-dark focus:border-2 focus:border-blue focus:shadow rounded" type="number" required>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="font-medium" for="3">Humidity</label>
                                                        <input id="3" v-model="humidity" class="form-control h-16 border-2 border-grey-dark focus:border-2 focus:border-blue focus:shadow rounded" type="number" min="0" required>
                                                    </div>

                                                    <div class="form-group flex justify-end">
                                                        <button class="btn btn-success m-1" type="submit"><span class="btn-label"><i class="fa fa-save"></i></span> Save</button>
                                                        <router-link :to="'/bird-housing/'+this.birdHousingID"  class="btn btn-default m-1">Cancel</router-link>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
    ...
    export default {
        ...
        methods: {
            getVaccinationOptions : function () {
                let URL = this.APIHosts.dhis+'/optionSets/'+this.optionSets.conditions+'.json?fields=displayName,options[id,name,code]';

                authResource().get(URL)
                    .then((response)=>{
                        this.conditions.push(...response.data.options)
            ...
            submit : function () {
                ...
                let dataValues = [
                    {dataElement : "orRq1Ikcvyd", value : this.conditionDate},
                    {dataElement : "wvlabNWzN6k", value : this.temperature},
                    {dataElement : "qOC1UA9pTbW", value : this.humidity,},
                ];
