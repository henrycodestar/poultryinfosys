            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><router-link :to="'/bird-housing/'+stateBirdHousing">{{ this.stateBirdHousing }}</router-link></li>
                ...
                <div class="container-fluid">
                            ...
                            <div class="container-fluid flex items-center p-0">
                                <div class="col-md-11">
                                    <p class="inline-block p-8 bg-white border-l-4 border-grey-dark">
                                        View the Conditions and Manage it below.
                                    </p>
                                </div>
                                <div class="col-md-1">
                        ...
                        <div class="row">
                            <div class="container-fluid flex items-center pb-0">
                                ...
                                <div class="col-md-9 flex justify-end items-center">
                                    <router-link class="btn btn-success m-1" :to="'/bird-housing/'+stateBirdHousing+'/conditions/add'"><span class="btn-label"><i class="mdi mdi-plus"></i></span> Add New</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="white-box">
                        ...
                        <td>{{index+1}}</td>
                        <td>{{getValue(programEvent,'orRq1Ikcvyd')}}</td>
                        <td>{{getValue(programEvent,'wvlabNWzN6k')}}</td>
                        <td>{{getValue(programEvent,'qOC1UA9pTbW')}}</td>
                        <td>{{programEvent.created}}</td>
                        <td>
                        <router-link class="btn btn-info btn-warning" :to="'/bird-housing/'+stateBirdHousing+'/conditions/'+programEvent.event+'/edit'"><span class="btn-label"><i class="fa fa-info-circle"></i></span>Edit</router-link>
...
<script>
    ...
    export default {
        name: 'BirdHousingShowAllConditions',
        components: {SideBar, NavBar},
        props: ['birdHousingID'],
        created() {
            // this.stateBirdHousing = 'HOVwD1JNNF4';
            this.stateBirdHousing = this.birdHousingID;
