        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                            ...
                            <div class="container-fluid flex items-center p-0">
                                <div class="col-md-11">
                                    <p class="inline-block p-8 bg-white border-l-4 border-grey-dark">
                                        View the Development Vaccines and Manage it below.
                                    </p>
                                </div>
                                <div class="col-md-1">
                        ...
                        <div class="row">
                            <div class="container-fluid flex items-center pb-0">
                                ...
                                <div class="col-md-9 flex justify-end items-center">
                                    <router-link class="btn btn-success m-1" :to="'/bird-cohorts/'+stateBirdCohort+'/vaccines/add'"><span class="btn-label"><i class="mdi mdi-plus"></i></span> Add New</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="white-box">
                        <div class="box-title">
                            <i class="fa fa-long-arrow-right"></i> All Vaccines ({{this.programEvents.length}})
                        </div>
                        ...
                        <td>
                        <router-link class="btn btn-info btn-warning" :to="'/bird-cohorts/'+stateBirdCohort+'/vaccines/'+programEvent.event+'/edit'"><span class="btn-label"><i class="fa fa-info-circle"></i></span>Edit</router-link>
...
<script>
    ...
    export default {
        name: 'BirdCohortsShowAllVaccines',
