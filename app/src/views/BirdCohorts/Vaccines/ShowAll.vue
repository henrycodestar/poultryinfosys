            ...
            <!--<div class="table-responsive">-->
                <!--<table class="table">-->
                    ...
                    <!--<tr v-for="(programEvent,index) in programEvents" v-bind:key="index">-->
                        ...
                        <!--<td>-->
                            <!--<router-link class="btn btn-info btn-warning" :to="`/bird-cohorts/${this.birdCohortID}/vaccines/${programEvent.event}/edit`"><span class="btn-label"><i class="fa fa-info-circle"></i></span>Edit</router-link>-->
...
<script>
    ...
    export default {
        name: 'BirdCohortsVaccinesShowAll',
        ...
        methods: {
            ...
            getProgramEvents : function () {
                let URL = this.APIHosts.dhis+'/events.json?program='+this.programs.birdCohorts+'&programStage=qgoGswZXWAS&orgUnit='+this.organisationUnit;
