                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><router-link :to="'/bird-cohorts/'+this.birdCohortID+'/vaccines'">Vaccines</router-link></li>
                            <li><a>Add</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                            ...
                            <div class="container-fluid flex items-center p-0">
                                <div class="col-md-11">
                                    <p class="inline-block p-8 bg-white border-l-2 border-blue-dark">
                                        Use the Input Form below to Add a New Vaccines.
                                    </p>
                                </div>
                                <div class="col-md-1">
                                            ...
                                            <div class="col-md-8">
                                                <form v-on:submit.prevent="submit">
                                                    <div class="form-group">
                                                        <label class="font-medium" for="name">Vaccination Date</label>
                                                        <input id="name" v-model="vaccinationDate" class="form-control h-16 border-2 border-grey-dark focus:border-2 focus:border-blue focus:shadow rounded" type="date" required>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="font-medium" for="vaccines">Vaccination Type</label>
                                                        <select id="vaccines" v-model="vaccinationType" class="form-control h-16 border-2 border-grey-dark focus:border-2 focus:border-blue focus:shadow rounded" required>
                                                            <option v-for="(vaccine, index) in vaccines" :key="index" :value="vaccine.code">{{ vaccine.name}}</option>
                                                        </select>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="font-medium" for="end-date">Number of Birds</label>
                                                        <input id="end-date" v-model="numberOfBirds" class="form-control h-16 border-2 border-grey-dark focus:border-2 focus:border-blue focus:shadow rounded" type="number" min="0" required>
                                                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            submit : function () {
                ...
                let dataValues = [
                    {dataElement : "uHwvTB7ZG7P", value : this.numberOfBirds},
                    {dataElement : "YVup3DxLdRI", value : this.vaccinationDate},
                    {dataElement : "LPXCbDKz7Bv", value : this.vaccinationType,},
                ];
