                ...
                <div class="container-fluid">
                            ...
                            <div class="container-fluid flex items-center p-0">
                                <div class="col-md-11">
                                    <p class="inline-block p-8 bg-white border-l-4 border-grey-dark">
                                        View all Batch details and Manage it below.
                                    </p>
                                </div>
                                <div class="col-md-1">
                        ...
                        <div class="row">
                            <div class="container-fluid flex items-center pb-0">
                                ...
                                <div class="col-md-9 flex justify-end items-center">
                                    <router-link :to="'/incubator-batches/'+this.incubatorBatchID+'/edit'" class="btn btn-warning m-1"><span class="btn-label"><i class="mdi mdi-pencil"></i></span> Edit</router-link>
                                    ...
                                    <div class="row">
                                        <div class="container-fluid p-0">
                                            <div class="col-md-2">
                                                ...
                                                <p>{{ getValue(this.trackedEntityInstance, 'KcbtonLHdsH')}}</p>
                                            </div>
                                            <div class="col-md-2">
                                                <span class="font-medium">Start</span>
                                                <p>{{ getValue(this.trackedEntityInstance, 'c8jfIOSaIqE')}}</p>
                                            </div>
                                            <div class="col-md-2">
                                                <span class="font-medium">End</span>
                                                <p>{{ getValue(this.trackedEntityInstance, 'wL8L6P45FYQ')}}</p>
                                            </div>
                                            <div class="col-md-2">
                                                <span class="font-medium">Bird Type</span>
                                                <p>{{ getValue(this.trackedEntityInstance, 'm1X2lR2i4hG')}}</p>
                                            </div>
                                            <div class="col-md-1">
                                                <span class="font-medium">Incubator</span>
                                                <p>{{ getValue(this.trackedEntityInstance, 'G2iWREX67Gn')}}</p>
                                            </div>
                                            <div class="col-md-3">
                    ...
                    <div class="mt-8">
                        <div class="row">
                            <div>
                                <div class="col-md-4">
                                    <router-link :to="'/incubator-batches/'+this.incubatorBatchID+'/setter-loading'">
                                        <div class="white-box hover:shadow">
                                            <h3 class="box-title">Setter Loading</h3>
                                ...
                                <div class="col-md-4">
                                    <router-link :to="'/incubator-batches/'+this.incubatorBatchID+'/development-statuses'">
                                        <div class="white-box">
                                            <h3 class="box-title">Development Status</h3>
                                            <ul class="list-inline m-t-30 p-t-10 two-part">
                                ...
                                <div class="col-md-4">
                                    <router-link :to="'/incubator-batches/'+this.incubatorBatchID+'/hatching'">
                                        <div class="white-box">
                                            <h3 class="box-title">Hatching</h3>
                                            <ul class="list-inline m-t-30 p-t-10 two-part">
                                                <li><i class="fa fa-users text-inverse"></i></li>
                                                <!--<li class="text-right"><span class="">5</span></li>-->
                                            </ul>
                                        </div>
                                    </router-link>
