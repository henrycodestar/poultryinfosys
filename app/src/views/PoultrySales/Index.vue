                            ...
                            <div class="container-fluid flex items-center p-0">
                                <div class="col-md-11">
                                    <p class="inline-block p-8 bg-white border-l-2 border-blue-dark">
                                        All Poultry Sales are listed below. Pick an Poultry Sales to View and Manage.
                                    </p>
                                </div>
                                <div class="col-md-1">
                        ...
                        <div class="row">
                            <div class="container-fluid flex items-center pb-0">
                                ...
                                <div class="col-md-9 flex justify-end items-center">
                                    <router-link class="btn btn-success m-1" to="/poultry-sales/add"><span class="btn-label"><i class="mdi mdi-plus"></i></span> Add New</router-link>
                                </div>
                            </div>
                        </div>
                    </div>

                    <PoultrySalesShowAll></PoultrySalesShowAll>
                </div>
            </div>
            <!-- /.container-fluid -->
...
<script>
    ...
    import PoultrySalesShowAll from "./ShowAll";
    export default {
        name: 'PoultrySalesHome',
        components: {PoultrySalesShowAll, SideBar, NavBar},
        methods: {
